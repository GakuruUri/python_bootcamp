...
# #Hint 13: Create a function called compare() 
# # and pass in the user_score and computer_score. 
# # If the computer and user both have the same score, 
# # then it's a draw. If the computer has a blackjack (0), 
# # then the user loses. If the user has a blackjack (0), 
# # then the user wins. If the user_score is over 21, 
# # then the user loses. If the computer_score is over 21, 
# # then the computer loses. If none of the above, 
...
#     # with every new card drawn and the checks 
